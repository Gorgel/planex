...
iteration = 1500 #15000

#b)
m = np.array([])
rho_ext_frac = np.array([])
PextList = np.linspace(4*10**-10,10**-15, iteration) 
...
P_unstable=PextList[Position_maxM]

print 'The cloud becomes unstable when the external pressure becomes ', P_unstable
